...
MPCSolver::MPCSolver(double mpcTimeStep, double controlTimeStep, double predictionTime, Eigen::Vector3d initialComPosition,
	...
	//DEBUG
	//std::cout << "initial com position mpc constructor" << std::endl;
    //std::cout << initialComPosition << std::endl;
    ...
    //DEBUG
    std::cout << "Number of samples in window = "<< N << std::endl;
    //
    ...
    this->supportFoot    = true;
    this->simulationTime = 0;
}

void MPCSolver::solve(Eigen::Vector3d measuredComPos, Eigen::Vector3d measuredComVel, Eigen::Vector3d measuredComAcc,
					  Aff3d swingFootTransform, bool supportFoot, double simulationTime, double vRefX, double vRefY, double omegaRef){
    ...
    //std::cout <<"cost function generation = "<< duration << std::endl;
    ...
    //std::cout << "constraint matrix generations = "<<duration1 << std::endl;
    ...
    //std::cout << "solveQP = "<<duration2 << std::endl;
...
void MPCSolver::changeReferenceFrame(Aff3d swingFootTransform) {
...
void MPCSolver::genSwingFootConstraint(Aff3d swingFootTransform) {
