classdef XLip_0 < Env.AbstractEnv
    ...
    methods
        function obj = XYLip_0(init_state,dt,reward,prm,varargin)
            obj.num_state            = 18;
            ...
            % Full system
            obj.A = blkdiag(A_lip, A_foot, A_foot, 1,1);
            obj.B = blkdiag(B_lip, B_foot, B_foot);
            obj.B(end+2,end) = 0; % additional empty inputs for the dummy states
