...
#ifndef INCLUDE_TEST_ENV_2DXY_LIP_2_HPP_
#define INCLUDE_TEST_ENV_2DXY_LIP_2_HPP_
...
class TwoDxyLip_2 : public abstractEnv {
...
public:
	    ...
	    TwoDxyLip_2(const std::string filename,bool act_vis,bool log = false){
	    ...
	    TwoDxyLip_2(Eigen::VectorXd init_state,double dt,double ft,prmXYLip_2 param,bool act_vis){
	    	    this->dim_state            = 18;
	    	    this->DOF                  = 6;
	    	    // to update bounds
	   	    	this->state_bounds         = Eigen::MatrixXd(4,2);
        ...
        void computeSystemMatrices(Eigen::MatrixXd& _A, Eigen::MatrixXd& _B, Eigen::MatrixXd& _C)
       	{
			  ...
			  // discretization
			  A_lip = Eigen::MatrixXd::Identity(3,3) + dt*A_lip;
			  B_lip = dt*B_lip;
...
#endif /* INCLUDE_TEST_ENV_2DXY_LIP_2_HPP_ */
